...
public interface CommentDAO {
    @Insert("insert into comment(user_id, post_id, content, create_time, change_time)values(#{userId}, #{postId}, #{content}, #{createTime}, #{changeTime})")
    ...
    @Select("delete from comment where id = #{commentId} and own_id = #{userId} ")
